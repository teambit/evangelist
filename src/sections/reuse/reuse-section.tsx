	...
	return (
		...
		>
			...
			<Grid className={styles.grid}>
				...
				<Image src="homepage-bit/60K-open-source-components.png" alt="visualization" fullWidth />
				...
				<Image src="homepage-bit/automated-GitHub-Updates.png" alt="visualization" fullWidth />
			</Grid>
			<Grid className={styles.grid}>
				<Details title="Organize and discover components">
					Keep components organized and segmented using labels and namespaces. Easily
				...
				<Image src="homepage-bit/hot-reloading-UI-playground.png" alt="visualization" fullWidth />
			</Grid>
		</div>
	);
}
