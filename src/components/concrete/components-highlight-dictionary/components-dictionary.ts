...
export const componentDictionary: ComponentHighlightDictionary = {
	...
	'concrete/cta-button': {
		displayName: 'concrete/cta-button',
		url: `${scopeUrl}/concrete/cta-button`,
	},
	'concrete/icon-line': {
		displayName: 'concrete/icon-line',
		url: `${scopeUrl}/concrete/icon-line`,
	},
	'concrete/marketing-card': {
		displayName: 'concrete/marketing-card',
